...
PRESETS = {
    ...
    # 앞공동은 짧고 슬릿·치열 때문에 손실이 커서 Q 가 낮다(대역폭 1000~1500 Hz).
    # 800 Hz 로 좁게 두면 -10 dB 폭이 3.1 kHz 밖에 안 되어 실제 /s/(4 kHz 이상)보다
    # 좁은 '단봉'이 되고, 넓은 쉬~ 소리가 아니라 삐~ 에 가깝게 들린다.
    "s":    (6600.0, 1200.0,  2900.0,  900.0,  0.5),
