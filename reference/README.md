...
각 논문에서 뽑아 쓴 수치와 **그 한계**는 [`../docs/LIQUID.md`](../docs/LIQUID.md)
§1 에 있다. 같은 문서 §2 에 이 녹음에서 직접 잰 값이 있고,
`scripts/measure_liquid.py` 로 다시 낼 수 있다.
...
것을 **인용의 인용임을 명시하고** 옮겨 적었다 — `docs/LIQUID.md` §1.5.
