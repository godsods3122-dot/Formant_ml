...
from formant_ml.liquid import (contact_dynamics, lateral_antiformants,
                               liquid_area, liquid_syllable)
...
def main() -> None:
    ...
    def render(name, seconds, keyframes, h0_pts, po, lateral=None, f0=None,
        ...
        # 세기와 성도 손실을 **접촉 신호에서** 만든다. 손으로 그리지 않는다.
