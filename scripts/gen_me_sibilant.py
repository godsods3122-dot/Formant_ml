...
#: 0.68 -> 0.41. 지속 마찰음의 구동을 다시 **호흡**으로 옮기면서(혀는 고원을
#: 유지한다, HANDOFF §5.8) 가청 구간이 짧아졌다 — 호흡 아치는 협착 궤적보다
#: 양 끝이 길게 눕는다. 재측정: 1.618 s 세그먼트 -> 가청 0.660 s (비 0.408),
#: 2.432 s -> 1.006 s (0.414).
AUDIBLE_FRAC = 0.41
